                ...
                <form className="flex flex-col items-center justify-center flex-1" onSubmit={handleSubmit(handleForm)}>
                    ...
                    <div className="input-wrapper w-96 mb-4">
                        <label htmlFor="username">
                            <p className="text-sm text-gray-500 font-bold mb-1">Username or email</p>
                            <input type="text" name="username" placeholder="example@email.com" className="border-b-2 border-gray-300 w-full bg-transparent text-gray-700 focus:bg-transparent focus:outline-none text-gray-600 pb-0.5 mt-0 focus:mt-2 ease-in-out transition-all delay-100 active:outline-none active:bg-transparent active:border-0 hover:outline-none"  {...register("username")} />
                        </label>
                    </div>
                    <div className="input-wrapper w-96 mb-4">
                    <label htmlFor="password">
                        <p className="text-sm text-gray-500 font-bold mb-1">Password</p>
                            <input type="text" name="password" placeholder="example@email.com" className="border-b-2 border-gray-300 w-full bg-transparent text-gray-700 focus:bg-transparent focus:outline-none text-gray-600 pb-0.5 mt-0 focus:mt-2 ease-in-out transition-all active:outline-none active:bg-transparent active:border-0 hover:outline-none" {...register("password")} />
                        </label>
                    </div>
