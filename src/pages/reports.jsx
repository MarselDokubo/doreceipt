            ...
            <div className="main mx-auto md:max-w-4xl mt-24 md:flex-1 px-4 ">
                ...
                <div className="rounded-b-xl bg-light-300 p-8 shadow-md md:p-14 pt-0 md:mx-auto ">
                    <div className="flex-1 max-w-52 mx-auto">
                        <img src="/src/assets/img/doreceipt/emptystate__reports.svg" alt="" width="620" height="565" className="object-cover"/>
                    </div>
                    <div className="text-center">
                        <h2 className="font-bold text-xl mb-2 ">The current filter show 0 reports.</h2>
                        <p className="font-normal text-xs md:text-base">Add filters or create a new report using the button above.
                        </p>
                    </div> 
                </div>
            </div>
...
function FilterOptions() {
    ...
    return (
        <div className="md:px-4 mt-6" onClick={(e) => {
            ...
            <div className="search mt-5 relative pl-6 md:pl-8 items-center md:flex gap-2 ">
                <i className="absolute left-0 top-1 font-expens expensicons  mr-1 md:text-xl text-slate-400 align-[-4px]">&#xE93C;</i>
                <div className="bg-white rounded-md max-w-96 mb-2 md:mb-0 px-2 p-0.5 flex-1 relative text-xs">
                        <input type="text" id="merchant" placeholder="Report ID, name or email" className="focus:text-gray-600 focus:outline-none border-r-2 w-full" />
                        <span className="font-expens expensicons text-slate-400 ml-[6px] align-[-1px] absolute right-1">&#xE93C;</span>
                </div>
                <div className="relative px-1 py-0.5 bg-white mb-2 md:mb-0 max-w-96 rounded-md border flex-1">
