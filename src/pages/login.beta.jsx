    ...
    return (
              <div className="auth-form  flex-1 flex   flex-col items-center justify-center h-screen">
                ...
                <form className="flex flex-col items-center justify-center flex-1" onSubmit={handleSubmit(handleForm)}>
                    ...
                    <button className="w-96 bg-primary-200 text-white text-base shadow-gray-800 rounded-full flex flex-col items-center font-bold mt-8 p-4  br-4 hover:bg-primary-300 hover:px-5 transition-all">Login</button>
                     ...
                     <div className="m-14  flex gap-2 w-full items-center justify-center">
                        ...
                        <button href="#" className="flex text-sm items-center gap-1 hover:text-gray-600 hover:underline transition-all"><img src="google.svg" /> Sign in with Google</button>
